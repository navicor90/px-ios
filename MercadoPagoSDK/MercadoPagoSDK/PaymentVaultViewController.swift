...
//        return numberOfRows
    ...
    func isMPLoginAvailable() -> Bool {
        return self.enableMPLogin && self.customerAccessToken.characters.count == 0 && self.isRoot
    }
